...
class EventsGvTab extends StatefulWidget {


  EventsGvTab({Key? key}) : super(key: key);

  @override
  State<EventsGvTab> createState() => _EventsGvTabState();
}

class _EventsGvTabState extends State<EventsGvTab> {
  ...
  Widget _buildItem(int index) {
    ...
    return InkWell(
        onTap: (){Navigator.push(context, MaterialPageRoute(builder: (context) => EventtiSingle(hotel),),);},
      ...
      appBar: AppBar(
        ...
        title: TextField(
          ...
          decoration: const InputDecoration(
            hintText: "Type Event Name or Location",
...
class EventtiSingle extends StatelessWidget {
