                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      AnimatedTextKit(
                        animatedTexts: [
                          TyperAnimatedText('AIC BARAKA',textStyle: GoogleFonts.abrilFatface(fontSize:28,fontWeight:FontWeight.bold,color: Colors.white)),
                          TyperAnimatedText('Welcomes YOU',textStyle: GoogleFonts.abrilFatface(fontSize:28,fontWeight:FontWeight.bold,color: Colors.white)),
