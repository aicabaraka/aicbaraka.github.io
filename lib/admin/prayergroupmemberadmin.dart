...
class PrayerGroupMemberTab extends StatefulWidget {

final String docId;
   PrayerGroupMemberTab({Key? key, required this.docId}) : super(key: key);

  @override
  State<PrayerGroupMemberTab> createState() => _PrayerGroupMemberTabState();
}

class _PrayerGroupMemberTabState extends State<PrayerGroupMemberTab> {
