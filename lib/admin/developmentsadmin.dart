...
class DevelopmentTab extends StatefulWidget {
  ...
  DevelopmentTab({Key? key}) : super(key: key);
...
class _DevelopmentTabState extends State<DevelopmentTab> {
  ...
  Widget _buildItem(int index) {
    ...
    return InkWell(
      onLongPress: (){
        showDialog(
          ...
          builder: (BuildContext context) {
            return AlertDialog(
              title: Text('Delete Development??'),
              content: Text('Are you sure you want to delete this Development?'),
              actions: <Widget>[
                TextButton(
                  onPressed: () {
      ...
      onTap: (){Navigator.push(context, MaterialPageRoute(builder: (context) => EditDevelopment(docId: hotelId,),),);},
                ...
                child:  Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Icon(Icons.hourglass_bottom,size: 15,),
                        Text(
                          hotel['name'] ,
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          Container(
            ...
            child: TextButton(
              onPressed: () {Navigator.push(context, MaterialPageRoute(builder: (context) => const AddDevelopment(),),);},
              child: const Text('Add Development',style: TextStyle(color: Colors.white),),
            ),
          ),
