...
class AddPrayerGroup extends StatefulWidget {

  const AddPrayerGroup ({Key? key}) : super(key: key);

  @override
  State<AddPrayerGroup> createState() => _AddPrayerGroupState();
}

class _AddPrayerGroupState extends State<AddPrayerGroup> {
  ...
  Future<void> addHotel() async {
    ...
    if (userDetailsSnapshot.docs.isNotEmpty) {
      ...
      try {
        String docId = FirebaseFirestore.instance.collection('prayergroup').doc().id;
        await FirebaseFirestore.instance.collection('prayergroup').doc(docId).set({
                            ...
                            children: [
                              GestureDetector(
                                ...
                                child: AnimatedTextKit(
                                  animatedTexts: [
                                    TyperAnimatedText('Add Prayer Group',textStyle: GoogleFonts.bebasNeue(fontSize:28,color: Colors.white)),
