...
class _SongsTabState extends State<SongsTab> {
  ...
  Widget _buildItem(int index) {
    ...
    return InkWell(
      ...
      //  onLongPress: (){Navigator.pu  sh(context, MaterialPageRoute(builder: (context) => deleteHotel,),);},



      onTap: (){Navigator.push(context, MaterialPageRoute(builder: (context) => EditSong(docId: hotelId,),),);},
                ...
                child:  Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Icon(Icons.music_note_outlined,size: 15,),
                        Container(
                          width: 83,

                          child: Text(
                            hotel['name'] ,
                            style: GoogleFonts.bebasNeue(color: Colors.deepPurple),overflow: TextOverflow.ellipsis,maxLines: 4,
                          ),
                        ),
        ...
        actions: [
          ...
          Container(
            ...
            child: TextButton(
              ...
              child: const Text('Add Song',style: TextStyle(color: Colors.white),),
            ),
          ),
