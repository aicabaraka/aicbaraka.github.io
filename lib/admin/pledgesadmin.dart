...
import 'package:aicbaraka/admin/addpledge.dart';
...
class PledgesTab extends StatefulWidget {


  PledgesTab({Key? key}) : super(key: key);

  @override
  State<PledgesTab> createState() => _PledgesTabState();
}

class _PledgesTabState extends State<PledgesTab> {
  ...
  Widget _buildItem(int index) {
    ...
    return InkWell(
      ...
      // onTap: (){Navigator.push(context, MaterialPageRoute(builder: (context) => EditPastor(docId: hotelId,),),);},
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: GoogleFonts.poppins(color: Colors.deepPurple,fontWeight: FontWeight.bold),
                      ),
      ...
      appBar: AppBar(
          ...
          onChanged: (value) {
            setState(() {
              ...
              _filteredHotels = _hotels.where((hotel) {
                ...
                final address = hotel['email'] as String;
        ...
        actions: [
          ...
          Container(
            ...
            child: TextButton(
              onPressed: () {
                Navigator.push(context, MaterialPageRoute(builder: (context) =>  AddPledge(),),);
              },
              child: const Text('Add Pledge',style: TextStyle(color: Colors.white),),
            ),
          ),
